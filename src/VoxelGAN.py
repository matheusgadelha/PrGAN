...
class RenderGAN:
    ...
    def train(self):
        ...
        for epoch in xrange(self.n_iterations):
            ...
            for batch_i in xrange(n_batches):
                ...
                ops.save_voxels(imgs_batch, "results/sanity_chairs_voxel")
    ...
    def discriminator(self, image, reuse=False):
        ...
        reshaped_img = tf.reshape(image, [self.batch_size, self.image_size[0], self.image_size[0], self.image_size[0], 1])
