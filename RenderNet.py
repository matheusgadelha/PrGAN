...
class RenderNet:
    ...
    def __init__(self, image_size=(64, 64), input_size=23, n_iterations=50, batch_size=64, lrate=0.001):
    ...
    def train(self):
        ...
        with tf.Session() as sess:
            ...
            for epoch in xrange(self.n_iterations):
                ...
                self.saver.save(sess, 'checkpoint/model.ckpt', global_step=training_step)
    ...
    def forward(self, render_params):
        ...
        img = np.array(self.prediction.eval(feed_dict={self.img_params: render_params}))
        return img.reshape((self.img.size[0], self.img.size[1], 3))
